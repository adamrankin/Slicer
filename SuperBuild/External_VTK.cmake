...
if((NOT DEFINED VTK_DIR OR NOT DEFINED VTK_SOURCE_DIR) AND NOT Slicer_USE_SYSTEM_${proj})
  ...
  if("${Slicer_VTK_RENDERING_BACKEND}" STREQUAL "OpenGL2" AND NOT Slicer_USE_OpenGLES)
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_VTK8_CMAKE_CACHE_ARGS
  ...
  if(Slicer_USE_OpenGLES)
    ExternalProject_SetIfNotDefined(
      ...
      "${EP_GIT_PROTOCOL}://github.com/adamrankin/VTK.git"
      QUIET
      )
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS
      -DVTK_OPENGL_USE_GLES:BOOL=ON
      )
    if(Slicer_USE_OpenGLES_EGL)
      list(APPEND EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS
